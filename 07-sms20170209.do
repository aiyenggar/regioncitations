...
corrtex cit_recd_total cit_recd_nonself cit_recd_self  rcit_made_localinternal rcit_made_localexternal rcit_made_nonlocalinternal rcit_made_nonlocalexternal  rcit_made_local rcit_made_internal  lncit_made_total lnpatents lnpool if e(sample) == 1, file(a.e.o.t.n.tcorrelation.tex) digits(2) no key(a.e.o.t.n.tcorrelation) title("Correlation table for all citations with DV as Total Citations Received") replace  
sutex cit_recd_total cit_recd_nonself cit_recd_self  rcit_made_localinternal rcit_made_localexternal rcit_made_nonlocalinternal rcit_made_nonlocalexternal  rcit_made_local rcit_made_internal  lncit_made_total lnpatents lnpool if e(sample) == 1, file(a.e.o.t.n.tsummary.tex) labels key(a.e.o.t.n.tsummary) title("Summary statistics for all citations with DV as Total Citations Received") replace 
...
corrtex cit_recd_total cit_recd_nonself cit_recd_self  rcit_made_localinternal rcit_made_localexternal rcit_made_nonlocalinternal rcit_made_nonlocalexternal  rcit_made_local rcit_made_internal  lncit_made_total lnpatents lnpool if e(sample) == 1, file(a.e.o.t.n.ncorrelation.tex) digits(2) no key(a.e.o.t.n.ncorrelation) title("Correlation table for all citations  with DV as Non-Self Citations Received") replace 
sutex cit_recd_total cit_recd_nonself cit_recd_self  rcit_made_localinternal rcit_made_localexternal rcit_made_nonlocalinternal rcit_made_nonlocalexternal  rcit_made_local rcit_made_internal  lncit_made_total lnpatents lnpool if e(sample) == 1, file(a.e.o.t.n.nsummary.tex) labels key(a.e.o.t.n.nsummary) title("Summary statistics for all citations with DV as Non-Self Citations Received") replace 
