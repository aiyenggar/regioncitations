...
/*
One table with:
Model 1: DV - All Citations Received. All Locations. 1990 onward. All Citations.
Model 2: DV - All Citations Received. U.S. Locations. 1990 onward. All Citations.
Model 3: DV - All Citations Received. Non-U.S. Locations. 1990 onward. All Citations.
Model 4: DV - Nonself Citations Received. All Locations. 1990 onward. All Citations.
...
corrtex cit_recd_total cit_recd_nonself  rcit_made_localinternal rcit_made_localexternal rcit_made_nonlocalinternal rcit_made_nonlocalexternal rcit_made_other lncit_made_total lnpatents lnpool if e(sample) == 1, file(`reportdir'`inputprefix'-`yearmin'-`distest'-correlation.tex) digits(2) no key(`inputprefix'-`yearmin'-`distest'-correlation) title("Correlations and Summary Statistics (Sample:`inputprefix'-`yearmin'-`distest')") replace  
sutex cit_recd_total cit_recd_nonself   rcit_made_localinternal rcit_made_localexternal rcit_made_nonlocalinternal rcit_made_nonlocalexternal  rcit_made_other  lncit_made_total lnpatents lnpool if e(sample) == 1, minmax file(`reportdir'`inputprefix'-`yearmin'-`distest'-summary.tex) labels key(`inputprefix'-`yearmin'-`distest'-summary) title("Summary Statistics (Sample:`inputprefix'-`yearmin'-`distest')") replace 
...
esttab model1 model2 model3 model4 model5 model6  using `reportdir'`inputprefix'-`yearmin'-`distest'-model.tex, ///
		title("Negative Binomial Regression Analysis of Invention Quality \label{`inputprefix'-`yearmin'-`distest'-model}") ///
