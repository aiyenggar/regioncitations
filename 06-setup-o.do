...
import delimited `destdir'o.backwardmap.csv, varnames(1) encoding(UTF-8) clear
save `destdir'o.backwardmap.dta, replace

import delimited `destdir'o.forwardmap.csv, varnames(1) encoding(UTF-8) clear
save `destdir'o.forwardmap.dta, replace

import delimited `destdir'o.citations.urbanareas.year.csv, varnames(1) encoding(UTF-8) clear
save `destdir'o.citations.urbanareas.year.dta, replace

use `destdir'o.citations.urbanareas.year.dta, clear
...
sort region year
save `destdir'o.patents_by_urbanareas.dta, replace
saveold `destdir'o.patents_by_urbanareas_stata12.dta, replace version(12) 

export delimited using `destdir'o.patents_by_urbanareas.csv, replace
