...
keep if ((maingroup_id == "C12N15/00") | (maingroup_id == "C12N9/00"))
...
label var patents_appyear "Patents granted (till March 2018, CPC:C12N15/00, C12N9/00)"
label var year_application "Application year"
twoway connected patents_appyear year_application if i_yearapplication == 1 & year_application >= 1980 & year_application <= 2014, xlabel(1980(5)2015) 

use `fn'yearassignee.dta, clear
drop year_grant patents_appyear assignees_year maingroup_id
rename patents_assignee_appyear y
reshape wide y, i(assignee_numid) j(year_application)
foreach var of varlist y1969-y2017 {
	replace `var' = 0 if missing(`var')
}
drop y1966 y1969-y1985
drop y2016-y2017
gen p19862015 = y1986 + y1987+ y1988 + y1989 + y1990 + y1991 + y1992 + y1993 + y1994 + y1995 + y1996 + y1997 + y1998 + y1999 + y2000 + y2001+ y2002 + y2003 + y2004 + y2005 + y2006 + y2007 + y2008 + y2009 + y2010 + y2011 + y2012 + y2013 + y2014 + y2015
order assignee p19862015 y*
gsort -p19862015
save `fn'yearwise.dta, replace

keep if p19862015 >= 30
keep assignee p19862015 y*
