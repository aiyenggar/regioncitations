...
foreach inputprefix in "20190306-ua1 20190306-ua2 20190306-ua3" {
    foreach distest in "CalcDistTrue CalcDistFalse" {
        ...
        rename uaid ua
        merge m:1 ua year using `destdir'`inputprefix'-ua_year_patents.dta, keep(match master) nogen
        rename ua uaid
