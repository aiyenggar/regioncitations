set more off
local destdir /Users/aiyenggar/processed/regioncitations/
local testdir `destdir'test/
...
drop myid
sort patent_id
export delimited `testdir'citation268k.csv, replace
...
sort patent_id
export delimited `testdir'citation100.csv, replace
...
keep if kp != 0
drop kp
export delimited `testdir'citation200k.csv, replace
